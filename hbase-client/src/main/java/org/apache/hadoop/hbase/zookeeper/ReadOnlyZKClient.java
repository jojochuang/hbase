...
public final class ReadOnlyZKClient implements Closeable {
  ...
  public CompletableFuture<byte[]> get(String path) {
    ...
    try (Scope scope = GlobalTracer.get().buildSpan("ReadOnlyZKClient.get").startActive(false)) {
  ...
  public CompletableFuture<Stat> exists(String path) {
    ...
    try (Scope scope = GlobalTracer.get().buildSpan("ReadOnlyZKClient.exists").startActive(false)) {
  ...
  public CompletableFuture<List<String>> list(String path) {
    ...
    try (Scope scope = GlobalTracer.get().buildSpan("ReadOnlyZKClient.list").startActive(false)) {
